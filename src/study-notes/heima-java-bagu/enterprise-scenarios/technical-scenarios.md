...
![image-20230521113500488](jscj-assets/image-20230521113500488.png)
...
![image-20230521113544219](jscj-assets/image-20230521113544219.png)
...
![image-20230521113906521](jscj-assets/image-20230521113906521.png)

使用jwt解决单点登录的流程如下：

![image-20230521113941467](jscj-assets/image-20230521113941467.png)
...
![image-20230521114305463](jscj-assets/image-20230521114305463.png)
...
![image-20230521114432028](jscj-assets/image-20230521114432028.png)
...
![image-20230521124717749](jscj-assets/image-20230521124717749.png)
...
![image-20230521125012727](jscj-assets/image-20230521125012727.png)
...
![image-20230521125136717](jscj-assets/image-20230521125136717.png)
...
- 常规采集：按天保存到一个日志文件![image-20230521232726959](jscj-assets/image-20230521232726959.png)

#### 5.2 ELK基本架构

ELK即Elasticsearch、Logstash和Kibana三个开源软件的缩写

![image-20230521232913086](jscj-assets/image-20230521232913086.png)
...
![image-20230521233150276](jscj-assets/image-20230521233150276.png)

也可以在logback配置文件中设置日志的目录和名字

![image-20230521233220905](jscj-assets/image-20230521233220905.png)
...
![image-20230521233554657](jscj-assets/image-20230521233554657.png)

![image-20230521233600556](jscj-assets/image-20230521233600556.png)

3. idea中启动远程debug![image-20230521233715574](jscj-assets/image-20230521233715574.png)
...
- 线上诊断工具Arthas(阿尔萨斯)，项目上线之后监控、排查
  ...
  - 核心功能：
    ...
    ![image-20230521233926897](jscj-assets/image-20230521233926897.png)

    ![image-20230521233934644](jscj-assets/image-20230521233934644.png)
